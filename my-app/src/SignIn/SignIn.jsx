...
class SignIn extends React.Component {
  ...
  render() {
    const { inputFlag, showPass, passCheck, passMsg, submit } = this.state;
    return (
      <div className="createAcct">
        ...
        <div className="formContainer">
          <form>
            ...
            <div className="inputContainer">
              <label>Zipcode</label>
              <input name="zip" onChange={this.handleBtn} maxLength='5' type="text" />
            </div>
          </form>
          <button disabled={ submit } >Create Account</button>
        </div>
      </div>
    );
  }
